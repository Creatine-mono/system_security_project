...
import { LayoutDashboard, Database, Wallet, BarChart3, Settings, HelpCircle, LogOut, Menu, Shield } from "lucide-react"
...
const navItems = [
  ...
  { name: "CVE History", href: "/dashboard/cve-history", icon: Database },
